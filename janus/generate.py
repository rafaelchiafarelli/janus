...
def write_project(app: App, out_dir: str | Path) -> list[Path]:
    ...
    `janus_actions.gen.h`, `janus_app.gen.c`, and `janus_generated.harpia`.
    Returns the paths actually written — content-diff-before-write means
    a no-op regeneration returns an empty list."""
